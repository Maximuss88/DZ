...
Решил, чтобы не запутаться, сначала сделать локально, без бэкэнда.
...
[max@max_centos terraform]$ terraform workspace list
  default
  prod
* stage

[max@max_centos terraform]$ terraform workspace select prod
Switched to workspace "prod".

[max@max_centos prod]$ terraform plan
